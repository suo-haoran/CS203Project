...
-- Setup user
insert into user(username, password, email, phone, country_of_residences, dob) value ('testuser1', 'test123', 'example@gmail.com', '+6512345768', 'SG', '1999-01-01');
...
insert into concert_image(name, concert_id, file_path) value ('iu.jpeg_1695207946703', 1, '/home/yanagi/dev/SMU/cs203proj/ticketing/../images/iu.jpeg_1695207946703');
